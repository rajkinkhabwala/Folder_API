"""
Django settings for Folders project.
...
SECRET_KEY = 'django-insecure-2%9h6)1ms%$8p7xyq+8svd8c!_q(dkyzw---=0$-6%l$&l1kxr'
...
WSGI_APPLICATION = 'Folders.wsgi.application'
